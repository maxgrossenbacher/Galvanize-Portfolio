...
if __name__ == '__main__':
    ...
    # 'activation': ['linear', 'sigmoid', 'tanh', 'relu', 'softplus', 'softsign']
    ...
    # Best Params: {'optimizer': 'Adagrad', 'num_neurons': 15, 'activation': 'linear', 'batch_size': 40, 'epochs': 20, 'kernel_initializer': 'normal'}, Best Score: 0.787887351982
